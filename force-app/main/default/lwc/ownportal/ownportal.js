...
import ownportal1 from '@salesforce/resourceUrl/ownportal';

export default class EmailAutomationService extends NavigationMixin(LightningElement) {

    heroImage = ownportal1;
